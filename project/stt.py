...
api_key = "1f8cy4HhZAMU5tXpCbd5NcwsNwEDILdBmAFON+vfDgU="
secret_key = "8j5lWGoZBZRUF4T4DQSbisNimDfauV5oxhea/9/0xi0="
...
def build_first_request(sample_rate_hertz, num_channels):
    ...
    req.streaming_config.config.num_channels = num_channels
    return req
